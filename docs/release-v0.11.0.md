...
> 主题：把电子辞典从**只有桌面端**扩展为**手机端（Capacitor 真 App）＋ 桌面/手机双向同步**。
...
| 文件 | 用途 |
|---|---|
| `zidiankaifa-0.11.0-x64.exe` | Windows 安装版 |
| `zidiankaifa-portable-0.11.0-x64.exe` | Windows 免安装版 |
| `zidiankaifa-0.11.0.apk` | Android 安装包 |
| `latest.yml` / `*.blockmap` | 桌面端自动更新元数据 |

**APK 签名指纹**（可用于确认安装包确为本项目发布、未被替换）：

```
SHA-256: D3:7C:04:A8:13:03:7C:B6:2B:45:A7:E0:F8:AC:4C:76:89:B8:6E:3E:E0:A1:9E:BA:0E:35:6A:0A:3A:30:85:1E
```
