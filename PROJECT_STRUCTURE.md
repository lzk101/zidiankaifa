...
| 文件 | 行数 | **独占写者** | 内容 |
|---|---|---|---|
| `BASELINE.md` | 116 | **主管** | 冻结基线：HEAD/测试/词库指纹 + **三把尺子口径表 §4** + §7 结构预算（T55 订正；**agent 总数 = 14**） |
| `TASKS.md` | 1180 | **主管** | 调度板：任务派单、阶段门、熔断记录、裁决索引（§11.9 = label 只读规则 · §11.10 裁决 E = 孙代理结案 · §11.11 收口） |
| `BOARD.md` | 2537 | **主管**（各 agent 只能**追加自己的小节**，R6） | 议题板：历代裁决（裁决一…二十一）＋ 结构 agent 区 |
